...
assert.match(shell, /MobileHomeThemeControls/)
assert.match(shell, /<select aria-label="Faction" value=\{family\}/)
assert.match(shell, /<option value="spartans">Spartans<\/option>/)
assert.match(shell, /<option value="amazonians">Amazonians<\/option>/)
