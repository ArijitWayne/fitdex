...
export const foodTutorialSteps: readonly GuideStep[] = [
  ...
  { title: 'Nutrition Targets', sections: [{ text: 'Targets are optional and can be edited from Settings. Calorie needs are estimates, not medical advice.' }, { text: 'Lose Weight suggestions use an estimated deficit. Eating farther below your target never earns more rewards; only eligible calorie-target days count.' }, { text: 'Protein targets are tracked separately from calories.' }] },
