...
assert.match(settings, /Nutrition Targets/)
assert.match(settings, />Goal</)
assert.match(settings, /My details/)
assert.match(settings, /Recommendation/)
...
assert.match(settings, /<details className="settings-disclosure"><summary>Calculation Profile<\/summary>/)
assert.doesNotMatch(settings, /<details className="settings-disclosure" open/)
